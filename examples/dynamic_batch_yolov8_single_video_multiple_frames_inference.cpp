...
int main(int argc, char *argv[]) { 
  ...
  for (bool preprocess_on_gpu : std::vector<bool>{false, true}) { 
  ...
  std::cout << "Batch Size | Execution Time (ms) without GPU Preprocessing | Execution Time (ms) with GPU Preprocessing\n";
